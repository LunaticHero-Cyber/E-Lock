...
<body>
    ...
    <div id="content" class="min">
        <div style="margin: auto; width: 75px;">
            <button id="submit" onclick="generateQR()">
                <div style="padding: 5px;text-align: center;">Get QR</div>
            </button>
        </div>
        <br>
        <div style="align-items: center; width: 256px; margin: auto;">
            <div id="qrcode"></div>
        </div>
        <br>
        <div id="feedcontent" style="margin: auto; width: 300px;"></div>
